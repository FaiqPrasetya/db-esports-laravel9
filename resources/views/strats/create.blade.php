                ...
                <div class="card-body">
                    <form action="{{ route('strats.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="map_name" id="map_name" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="file-control @error('strats_image') is-invalid @enderror"
                                id="strats_image" name="strats_image" required placeholder="Upload File" value="{{ old('strats_image')}}">
                            @error('strats_image')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('strats_name') is-invalid @enderror"
                                id="strats_name" name="strats_name" required placeholder="Strats Name" value="{{ old('strats_name')}}">
                            @error('strats_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="strats_desc" id="strats_desc" cols="30" rows="10"
                                ...
                                placeholder="Strats Description" required>{{ old('strats_desc')}}</textarea>
                            @error('strats_desc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="agent_one" id="agent_one" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agent_one_desc" id="agent_one_desc" cols="30" rows="10"
                                ...
                                placeholder="Agent One Description" required>{{ old('agent_one_desc')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agent_two" id="agent_two" class="form-control" required>
                                <option value="">Select Agent</option>
                                @foreach($agents as $agent)
                                    <option value="{{ $agent->agent_name }}">{{ $agent->agent_name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agent_two_desc" id="agent_two_desc" cols="30" rows="10"
                                ...
                                placeholder="Agent Two Description" required>{{ old('agent_two_desc')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agent_three" id="agent_three" class="form-control" required>
                                <option value="">Select Agent</option>
                                @foreach($agents as $agent)
                                    <option value="{{ $agent->agent_name }}">{{ $agent->agent_name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agent_three_desc" id="agent_three_desc" cols="30" rows="10"
                                ...
                                placeholder="Agent Three Description" required>{{ old('agent_three_desc')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agent_four" id="agent_four" class="form-control" required>
                                <option value="">Select Agent</option>
                                @foreach($agents as $agent)
                                    <option value="{{ $agent->agent_name }}">{{ $agent->agent_name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agent_four_desc" id="agent_four_desc" cols="30" rows="10"
                                ...
                                placeholder="Agent Four Description" required>{{ old('agent_four_desc')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="agent_five" id="agent_five" class="form-control" required>
                                <option value="">Select Agent</option>
                                @foreach($agents as $agent)
                                    <option value="{{ $agent->agent_name }}">{{ $agent->agent_name }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agent_five_desc" id="agent_five_desc" cols="30" rows="10"
                                ...
                                placeholder="Agent Five Description" required>{{ old('agent_five_desc')}}</textarea>
